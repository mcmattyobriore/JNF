...
class ApplicationMain
{
  ...
  public static function create(config):Void
  {
    ...
    appMeta.set("build", "56");
    appMeta.set("company", "The Funkin' Crew");
    appMeta.set("file", "Funkin");
    appMeta.set("name", "Friday Night Funkin'");
    appMeta.set("packageName", "me.funkin.fnf");
    appMeta.set("version", "0.7.5");
    ...
    #elseif air
    app.window.title = "Friday Night Funkin'";
    #else
  ...
  macro public static function getPreloader()
  {
    ...
    var type = Context.getType("funkin.ui.transition.preload.FunkinPreloader");
      ...
      case TInst(classType, _):
        ...
        while (searchTypes != null)
        {
          if (searchTypes.pack.length == 2 && searchTypes.pack[0] == "openfl" && searchTypes.pack[1] == "display" && searchTypes.name == "Preloader")
          {
            return macro
            {
              new funkin.ui.transition.preload.FunkinPreloader();
            };
          }
    ...
    return macro
    {
      new openfl.display.Preloader(new funkin.ui.transition.preload.FunkinPreloader());
    }
